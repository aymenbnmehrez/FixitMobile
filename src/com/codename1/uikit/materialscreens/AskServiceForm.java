 ...
 * @author aymen
 */
public class AskServiceForm extends SideMenuBaseForm {
...
//    }
    ...
    public AskServiceForm(Resources res) {
                ...
                = BorderLayout.north(
                        ...
                        add(BorderLayout.SOUTH,
                                FlowLayout.encloseIn(
                                        new Label("  Ask For ", "WelcomeBlue"),
                                        new Label("A Service", "WelcomeWhite")
                                ));
        ...
        TextField description = new TextField("username", "Login", 20, TextField.EMAILADDR);
        TextField startedAt = new TextField("password", "Password", 20, TextField.EMAILADDR);
        description.getAllStyles().setMargin(LEFT, 0);
        startedAt.getAllStyles().setMargin(LEFT, 0);
        Label loginIcon = new Label("", "TextField");
        Label passwordIcon = new Label("", "TextField");
        loginIcon.getAllStyles().setMargin(RIGHT, 0);
        passwordIcon.getAllStyles().setMargin(RIGHT, 0);
        FontImage.setMaterialIcon(loginIcon, FontImage.MATERIAL_EVENT, 3);
        ...
        add(BorderLayout.CENTER,
          ...
          Container az = BoxLayout.encloseY(
                BorderLayout.center(description).
                        add(BorderLayout.WEST, loginIcon),
                BorderLayout.center(startedAt).
                        add(BorderLayout.WEST, passwordIcon)
                
                );
        add(BorderLayout.CENTER, az);
