...
//     a=Statics.createBackBtn(theme);
    ...
    private void showMeOnMap() {
       ...
       map.setToolbar(tmp);
 map.getToolbar().addCommandToLeftBar(new MapsDemoForFav.BackCommand());
        ...
        map.setBackCommand(new MapsDemoForFav.BackCommand());
    ...
    private void putMeOnMap(MapComponent map) {
       ...
       StringTokenizer st = new StringTokenizer(DisplayMoreFav.locationn,",");      
       st.toString();    
           int z =0;
